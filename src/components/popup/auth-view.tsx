...
export default function AuthView({ onSignIn }: AuthViewProps) {
  return (
    <main className="flex flex-1 flex-col items-center justify-center bg-background p-8 text-center">
      ...
      <h1 className="text-4xl font-bold text-foreground">Welcome to PassKey Pro</h1>
      <p className="mt-4 max-w-sm text-base text-muted-foreground">
        Your secure and simple solution for password management.
      </p>
      <Button onClick={onSignIn} className="mt-12" size="lg">
